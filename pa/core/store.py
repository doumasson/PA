...
class Store:
    ...
    async def connect(self) -> None:
        ...
        # WAL lets the bot and the out-of-process repair daemon read/write the
        # same DB without "database is locked", and synchronous=NORMAL cuts the
        # fsync rate that grinds the SD card. busy_timeout waits out brief locks.
    ...
    async def executescript(self, sql: str) -> None:
        """Run a multi-statement script (core module schemas)."""
